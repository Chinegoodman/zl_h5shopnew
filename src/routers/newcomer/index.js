export default [{
    ...
    //商城首页
    {
        ...
        name: 'newcomerindex',
        component: () =>
            import ('./../../views/newcomer/index/index.vue'),
        meta: {
            name: 'newcomerindex',
            navstatus: true,
            //面包屑需要的参数
    ...
    //新人专区规则
    {
        path: 'newcomerrole',
        name: 'newcomerrole',
        component: resolve => require(['./../../views/newcomer/newcomerrole/index.vue'], resolve),
        meta: {
            name: 'newcomerrole',
            navstatus: false,
            //面包屑需要的参数
            breadnav: [{
                    name: '新人专区规则',
                    url: '/newcomerrole/index',
                },
                {
                    name: '新人专区规则',
                    url: '/newcomer/newcomerrole',
                },
            ]
        }
    }

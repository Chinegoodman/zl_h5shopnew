...
id = "shopwrap" >
    ...
    div class = "header" >
    <
    div @click = "gotosertchpage"
class = "searchbtn" >
    <
    img src = "@/assets/imgs/video/fangdj@2x.png"
alt = "抓周" / >
    <
    ...
    span class = "im" >
    <
    img src = "@/assets/imgs/shop/xunbao.png"
alt = "抓周" / >
    <
    /span> <
    ...
    span class = "im" >
    <
    img src = "@/assets/imgs/shop/xiaoxi.png"
alt = "抓周" / >
    <
    /span> <
    ...
    <
    img src = "@/assets/imgs/icons/xiaoxqp.png"
alt = "抓周 无消息" / >
    <
    /div> --> <
    /div> <
    ...
    <
    van - tab: title = "tit.category_name"
v -
    for = "(tit, index) in titlistmassage": key = "index" >
    <
    div class = "tab-title"
slot = "title"
@click = "titleclick(tit.tabindex,1)" > {
        { tit.category_name } } < /div> <
    /van-tab> <
    /van-tabs> <
    /div> <
    div class = "swiper" >
    ...
    <
    van - swipe - item v -
    for = "(image, index) in images": key = "index" >
    <
...
@click = "imageurl(image)" / >
    ...
    div class = "tipsbox"
v -
    if = "list_content_show_type != 2" >
    <
p >
    <
    img src = "@/assets/imgs/icons/dppz.png"
alt = "大牌品质，工厂价格，个性定制，创意者秀" / >
    <
    span > 大牌品质 < /span> <
    /p> <
    p >
    <
    img src = "@/assets/imgs/icons/gcjg.png"
alt = "大牌品质，工厂价格，个性定制，创意者秀" / >
    <
    span > 工厂价格 < /span> <
    /p> <
    p >
    <
    img src = "@/assets/imgs/icons/gxdz.png"
alt = "大牌品质，工厂价格，个性定制，创意者秀" / >
    <
    span > 个性定制 < /span> <
    /p> <
    p >
    <
    img src = "@/assets/imgs/icons/cyzx.png"
alt = "大牌品质，工厂价格，个性定制，创意者秀" / >
    <
    span > 创意者秀 < /span> <
    /p> <
    /div> <
    div class = "bangdanguild"
v - show = "list_content_show_type===2" >
    <
    div class = "lis tuhao" >
    <
    ...
    span class = "ic" >
    <
    img src = "@/assets/imgs/shop/white-gd.png"
alt = "抓周" / >
    <
    /span> <
    /div> <
...
v - show = "guildarea.length > 0 && list_content_show_type===0" >
    <
    ul >
    <
    li v -
    for = "(item,index) in guildarea": key = "index"
id = "item.id": to = "item.toUrl"
@click = "gotodiamondlist(item)" >
    <
    span class = "m" >
    <
    img: src = "item.pictureUrl?item.pictureUrl:default_img_guildarea"
alt = "抓周" / >
    <
    /span> <
    span class = "t" > {
    ...
    /ul> <
    /div> <
    div @click = "gonewcomer"
class = "newcomerindexguild"
v - show = "list_content_show_type===0" >
    <
    img src = "http://playback.17biyi.com/53eb461b1acea844204c921440705211"
alt = "" >
    <
    /div>
...
<!-- 推荐列表数据展示 -->
<
div class = "index_list_recommend sun"
v - show = "list_content_show_type===0" >
    <
    ...
    van - list
class = "goodslist"
v - model = "listloading": finished = "listfinished": finished - text = "finished_text": error.sync = "vanerror"
error - text = "请求失败，点击重新加载": offset = "10"
@load = "homelisttj" >
    <
    div
...
class = "goodsli"
v -
    for = "(item,index) in homelistmassage": key = "index": id = "item.id" >
    <
    div class = "im" >
    <
    img: src = "item.glp.smallImage?item.glp.smallImage:default_img_small"
alt = ""
v -
    if = "change_big_small_flag_tj===1" / >
    <
img: src = "item.glp.bigImage?item.glp.bigImage:default_img_big"
alt = ""
v -
    if = "change_big_small_flag_tj===0" / >
    <
    /div> <
div class = "goodsli_title clearfix" >
    ...
    span class = "img_w" >
    <
    img: src = "item.face_url?item.face_url:default_img_head"
alt = "抓周" / >
    <
    /span> <
    h2 class = "_txtov2": class = "{'indent':item.nickname}" > {
        { item.nickname } } < /h2> <
    /div> <
    span class = "tit" > {
        { item.name } } < /span> <
    div class = "zan"
@click.stop = "clickPraisePoint(index)" >
    <
    piontPraise: livingUid = "item.uid": livingId = "item.id"
ref = "piontPraise" > < /piontPraise> <
    /div> <
    div class = "gd_btm" >
    <
    span class = "zb"
v -
    if = "item.state==0" > < /span> <
span class = "huifang"
v -
    if = "item.state==1" > < /span> <
span class = "num" > {
    { item.realcount } }
观看 < /span> <
    /div> <
    /div> <
    /van-list> <
    div class = "changebigsize"
v -
    if = "change_big_small_flag_tj===1"
@click = "changeimgsize_tj()" > < /div> <
    div class = "changesmallsize"
v -
    if = "change_big_small_flag_tj===0"
@click = "changeimgsize_tj()" > < /div> <
    /div> <
    ...
    <!-- 直播列表数据展示 --> 
    <
    div class = "index_list_recommend lili"
v - show = "list_content_show_type===1" >
    <
    div class = "nav_type" >
    <
    ul >
    <
    li v -
    for = "(tit, index) in zhibotitletype": class = "{'active':tab_active==index}": key = "index"
@click = "tabtittypezhibo(tit,index)" > {
        { tit.name } } < /li> <
    /ul> <
    /div>
    ...
    van - list
class = "goodslist"
v - model = "listloading_zb": finished = "listfinished_zb": finished - text = "finished_text_zb": error.sync = "vanerror_zb"
error - text = "请求失败，点击重新加载": offset = "10"
@load = "homelistzb" >
    <
    div
...
class = "goodsli"
v -
    for = "(item,index) in homelistzbmsg": key = "index": id = "item.id" >
    <
    div class = "im" >
    <
    img: src = "item.glp.smallImage?item.glp.smallImage:default_img_small"
alt = "珠宝商品"
v -
    if = "change_big_small_flag_zb===1" / >
    <
img: src = "item.glp.bigImage?item.glp.bigImage:default_img_big"
alt = "珠宝商品"
v -
    if = "change_big_small_flag_zb===0" / >
    <
    /div> <
div class = "goodsli_title clearfix" >
    <
...
v - show = "list_content_show_type===2" >
    ...
    van - list
class = "goodslist"
v - model = "listloading_xc": finished = "listfinished_xc": finished - text = "finished_text_xc": error.sync = "vanerror_xc"
error - text = "请求失败，点击重新加载": offset = "10"
@load = "homelistxc" >
    <
    div
...
class = "goodsli"
v -
    for = "(item,index) in homelistxcmsg": key = "index": id = "item.id" >
    <
    div class = "im" >
    <
    img: src = "item.cover?item.cover:default_img_small"
alt = "" / >
    <
    /div> <
    div class = "goodsli_title clearfix" >
    ...
    span class = "img_w" >
    <
    img: src = "item.faceUrl?item.faceUrl:default_img_head"
alt = "抓周" / >
    <
    /span> <
    h2 class = "_txtov2": class = "{'indent':item.nickName}" > {
...
v -
    ...
    <!-- 新品列表数据展示 --> 
    <
div class = "index_list_recommend wang"
v - show = "list_content_show_type===3" >
    <
    div class = "nav_type" >
    <!-- 分类tab -->
    <
    ...
    <
    li v -
    for = "(tit, index) in xinpintitletype": class = "{'active':tab_active_xp==index}": key = "index"
@click = "tabtittypexinpin(tit,index)" > {
        { tit.name } } < /li> <
    /ul> <
    /div> <
    ...
    <
    li v -
    for = "(item,index) in xinpintitsort": key = "index": class = "{'active' : titesortactive==index}"
@click = "tabsort(item)" >
    <
    span class = "t"
v -
...
span class = "pricearrow_w" >
    <
    span: class = "{'pricearrow' : true,'pricearrowupactive' : price_up ,'pricearrowdownactive' : price_down }"
ref = "pricearrow" > < /span> <
    /span>  <
    /span> <
    span class = "t"
v -
        ...
        <
        span class = "t"
@click = "filtershow" > 筛选 < span class = "ic" > < img src = "@/assets/imgs/shop/bgfiltter.png"
alt = "" > < /span></span >
    <
    /div> <
    /div> 
    <!-- 筛选弹层 start-->
    <
    div class = "filter_tan"
v -
    if = "filtershow_flag" >
    <
div class = "bg_cover"
@click = "close_filter_tan" > < /div> <
...
ref = "input_max" / >
    ...
    <
    li v -
    for = "(item,index) in price_area_step": key = "index": class = "{'active' : price_area_step_active===index}"
@click = "choose_price_area(item,index)" > {
        { item.name } } <
    /li> <
    /ul> <
    div class = "btn_area" >
    ...
    span class = "s"
@click = "price_area_step_save" > 确定 < /span> <
    /div> <
    /div> <
    /div>
    <!-- 筛选弹层 end-->
    ...
    van - list
class = "goodslist_xp"
v - model = "listloading_xp": finished = "listfinished_xp": finished - text = "finished_text_xp": error.sync = "vanerror_xp"
error - text = "请求失败，点击重新加载": offset = "10"
@load = "homelistxp" >

    <
    div class = "goodsli_xp"
@click = "gotogoodsdetails(item)"
v -
    for = "(item,index) in homelistxpmsg": key = "index": id = "item.goods_id" >
    <
    div class = "im" >
    <
    img: src = "item.goods_image?item.goods_image:default_img_small"
alt = "珠宝商品" / >
    <
    /div> <
    span class = "tit" > {
        { item.goods_title } } < /span> <
    div class = "price" > < span > ￥ < /span>{{item.price}}</div >
    <
    div class = "canged"
v -
    if = "item.isCollection==1"
@click.stop = "mycollect(item)" > < /div> <
    div class = "cang"
v -
...
@click.stop = "mycollect(item)" > < /div> <
    ...
    div class = "changebigsize"
v -
    if = "change_big_small_flag_xp===1"
@click = "changeimgsize_xp()" > < /div> <
    div class = "changesmallsize"
v -
    if = "change_big_small_flag_xp===0"
@click = "changeimgsize_xp()" > < /div> <
    /div> <
    /div>  
...
<!-- 投资金列表start -->
<
div class = "rongtongjin-ad"
v -
    if = "list_content_show_type===4" >
    <
span class = "ad-tit" >
    <
    img src = "@/assets/imgs/shop/rongtongjin-tit.png"
alt = "" >
    <
    /span> <
    div class = "add-con"
...
span > 投资金价： < /span> <
    ...
    <
    span: class = "{'role-type-level' : true,'role-type-down':goldpricedata.trend==2,'role-type-up':goldpricedata.trend==1}" > {
        { goldpricedata.goldPrice ? goldpricedata.goldPrice : '获取中...' } } < span v -
    if = "goldpricedata.goldPrice" > /克</span > < /span> <
span class = "ic"
v -
    if = "goldpricedata.trend==2" > < img src = "@/assets/imgs/shop/jin-jiang.png"
alt = "" > < /span> <
    span class = "ic"
v -
    if = "goldpricedata.trend==1" > < img src = "@/assets/imgs/shop/jin-zhang.png"
alt = "" > < /span> <
    /div> <
    div class = "jin-annimation" >
    <
...
alt = "" > < /span> <
    ...
    span class = "ad-jin" >
    <
    img src = "@/assets/imgs/shop/rongtongjin-jin.png"
alt = "" >
    <
    /span> <
    /div> <
    div class = "index_list_recommend tzj"
v - show = "list_content_show_type===4" >
    <
    div class = "title" > < span class = "ic" > < /span>为你推荐</div >
    <!-- big_list 为切换到大图的class -->
    <
    ...
    van - list
class = "goodslist"
v - model = "listloading_tzj": finished = "listfinished_tzj": finished - text = "finished_text_tzj": error.sync = "vanerror_tzj"
error - text = "请求失败，点击重新加载": offset = "10"
@load = "homelisttzj" >
    <
    div
...
class = "goodsli"
v -
    for = "(item,index) in homelisttzjmsg": key = "index": id = "item.goods_id" >
    <
    div class = "show-flag-goods"
v -
    if = "item.sku_id" >
    <
div class = "im" >
...
alt = "珠宝商品"
v -
    if = "change_big_small_flag_qb===1" / >
    <
img: src = "item.glp.bigImage?item.glp.bigImage:default_img_big"
alt = "珠宝商品"
v -
    if = "change_big_small_flag_qb===0" / >
    <
    /div> <
div class = "goodsli_title clearfix" >
    <
...
观看 < /span> <
    ...
    div class = "changebigsize"
v -
    if = "change_big_small_flag_tzj===1"
@click = "changeimgsize_tzj()" > < /div> <
    div class = "changesmallsize"
v -
    if = "change_big_small_flag_tzj===0"
@click = "changeimgsize_tzj()" > < /div> <
    /div> <
    /div> 
    <!-- 投资金列表 end -->
    <
    nodata: pagetype = "pagetypedata"
v -
    if = "nodatashow" > < /nodata> <
newcomershell: newcomershellshowstate = "newcomershellshowstate"
@closecomershellclick = "closecomershell" > < /newcomershell> <
    /div> <
    /template>
...
shopwrap.van - swipe__indicators {
    padding: 0.06 rem 0.18 rem;
    background - color: rgba(0, 0, 0, 0.23);
    border - radius: 0.105 rem;
}#
...
shopwrap.van - swipe__indicator--active {
    ...
    // 商品列表模块加载更多提示框居中
    #
shopwrap.van - list__error - text, #shopwrap.van - list__finished - text, #shopwrap.van - list__loading {
    margin: 0 auto;
    line - height: 3e m;
    width: 100 % ;
}#

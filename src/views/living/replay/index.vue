    ...
    <div v-if="livingendstatus" class="videoswrap"  @click.capture="videoplay">
      ...
      <div class="video-content">
        ...
        <div class="content-top">
          <div class="clearfix">
            <div class="dzname clearfix" @click.stop="returnfn">
              <div class="dznamepic">
                <img v-if="livinglidata.face_url" :src="livinglidata.face_url" alt="聚美金品" />
              </div>
              <div class="dzguankan">
            ...
            <div class="msgboxwrapouter" ref="msgboxwrap">
              <div class="msgboxwrap">
                <div class="msgbox clearfix">
                    ...
                    <p class="name">系统公告：</p>
                    <p class="warmtips"> 请文明发言，禁目发布违法违规内容；购买推荐产品请确认您拍下的链接描述与实际商品一致；切勿相信线下直接转账等非通过本平台结算的交易方式工，谨防上当受骗！ </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div @click="hlrtipsstatus=true" class="hlrtipsbtn" v-if="false">
          <img src="./../../../assets/imgs/living/details/hlr.png" alt="聚美金品" />
        </div>
        ...
        <div class="hlrtipsbtn member">
          <img src="./../../../assets/imgs/living/details/member.png" alt="聚美金品" />
        </div>
      </div>
    </div>
    <!-- 确认支付弹窗界面 -->
